...
#SBATCH --job-name=seed-inf5820
#SBATCH --account=nn9447k
#SBATCH --time=00:30:00
#SBATCH --partition=accel
#SBATCH --gres=gpu:1
#SBATCH --mem-per-cpu=10000
#SBATCH --output=./logs/baseline-seed.log
...
for ((i=1; i <= NUM_ITERS; i++)); do
    ...
    python train_model.py --mode=static --results_path="$OUTPUT_FILE" --word_vectors="$WORD_VECTORS" --seed="$SEED" --model_tmp_path="seed.model.tmp"
done
